...
local _t = require("arshlib.tables").new
...
describe("Table", function()
  ...
  describe("find_first", function()
    ...
    it("returns first match", function()
      local got = t:find_first(function(v)
        return v == 3
      end)
  ...
  describe("contains_fn", function()
    ...
    it("returns true when match", function()
      local got = t:contains_fn(function(v)
        return v == 3
      end)
      assert.is_true(got)
    end)
  ...
  describe("chunk", function()
    ...
    it("returns tables of length 1 with chunk size 1", function() end)
  ...
  describe("map_length", function()
    ...
    it("zero length", function()
      assert.are.same(0, _t({}):map_length())
    end)
